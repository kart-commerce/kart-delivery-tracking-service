...
/// <summary>Shared retry-count header parsing for this service's two consumer hosted services (RabbitMQ has no built-in redelivery counter for the retry-ladder pattern).</summary>
